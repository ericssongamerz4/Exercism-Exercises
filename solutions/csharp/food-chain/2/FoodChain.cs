 ...
 {
     private static readonly Dictionary<int, string> Animal = new()
     {
         {1,"fly" },
         {2,"spider" },
         {3,"bird" },
     ...
     private static readonly Dictionary<int, string> secondVerse = new()
     {
         {1, string.Empty },
     ...
     private static string FirstLine(int verseNumber) => $"I know an old lady who swallowed a {Animal[verseNumber]}.\n";
     private static string SecondLine(int verseNumber) => secondVerse[verseNumber];
     private static string MiddleLine(int verseNumber) => $"She swallowed the {Animal[verseNumber]} to catch the {Animal[verseNumber - 1]}{SpiderBonus(verseNumber)}.\n";
