...
namespace Exercism_Exercises.Exercises.GradeSchool;
/*
Instructions
...
Get a sorted list of all students in all grades. Grades should be sorted as 1, 2, 3, etc., 
...
and each student cannot be added more than once to a grade or the roster. 
...
public class GradeSchool
{
    ...
    private readonly Dictionary<string, int> studentGrades = [];
