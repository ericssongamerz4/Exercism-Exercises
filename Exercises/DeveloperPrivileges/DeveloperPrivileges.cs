...
namespace Exercism_Exercises.Exercises.DeveloperPrivileges
{
    public class Authenticator
    {
        private static Identity GetNewIdentity(string email, string eyeColor, decimal philtrumWidth, List<string> nameAndAddress) => new Identity
        {
            Email = email,
