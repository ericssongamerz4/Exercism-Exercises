namespace Exercism_Exercises.Exercises.InternationalCallingConnoisseur
{
    public static class DialingCodes
    {
        ...
        public static bool CheckCodeExists(Dictionary<int, string> existingDictionary, int countryCode) => existingDictionary.TryGetValue(countryCode, out var value);
        ...
        public static string FindLongestCountryName(Dictionary<int, string> existingDictionary) => existingDictionary.Values.MaxBy(name => name.Length) ?? string.Empty;
    }
}
