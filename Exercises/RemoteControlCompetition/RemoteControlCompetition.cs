...
namespace Exercism_Exercises.Exercises.RemoteControlCompetition
{
    ...
    public class ProductionRemoteControlCar : IRemoteControlCar, IComparable<ProductionRemoteControlCar>
    {
        ...
        public int CompareTo(ProductionRemoteControlCar? other) => (other is null) ? 1 : NumberOfVictories.CompareTo(other.NumberOfVictories);
